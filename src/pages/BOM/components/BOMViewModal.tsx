          ...
          <div>
            {bomDetail && (bomDetail.approvalStatus.toLowerCase() === 'revisit'|| bomDetail.approvalStatus.toLowerCase() === 'pending') && (
              <button
                ...
                className="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-primary-500 border border-transparent rounded-md hover:bg-primary-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 disabled:bg-blue-300 disabled:cursor-not-allowed transition-colors duration-200"
              >
                {sendingForApproval ? (
                  <>
