...
import { FileSpreadsheet, Filter, Download, Plus, CheckCircle } from 'lucide-react';
...
const Quotations: React.FC = () => {
  ...
  const handleApprovalAction = (quotationId: string, action: 'approve' | 'reject', reason?: string) => {
